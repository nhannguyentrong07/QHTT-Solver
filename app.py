...
# ══════════════════════════════════════════════════
mau_dict = {
    "[Tùy chỉnh] Nhập hệ số thủ công": None,
    "Mẫu 1: Hệ Khả thi chuẩn (Đơn hình Gốc)": {"n": 2, "m": 2, "obj": "Min", "c": [-5.0, -4.0], "A": [[6.0, 4.0], [1.0, 2.0]], "b": [24.0, 6.0], "dau": ["<=", "<="], "cond": ["≥ 0", "≥ 0"]},
    "Mẫu 2: Khả thi Đối ngẫu (Đơn hình Đối ngẫu)": {"n": 2, "m": 2, "obj": "Min", "c": [3.0, 4.0], "A": [[-1.0, -2.0], [-3.0, -1.0]], "b": [-4.0, -6.0], "dau": ["<=", "<="], "cond": ["≥ 0", "≥ 0"]},
    "Mẫu 3: Hệ Không khả thi (Phương pháp Hai Pha)": {"n": 2, "m": 2, "obj": "Min", "c": [1.0, -1.0], "A": [[-1.0, -1.0], [2.0, -1.0]], "b": [-2.0, 2.0], "dau": ["<=", "<="], "cond": ["≥ 0", "≥ 0"]},
    "Mẫu 4: Tập phương án rỗng (Vô nghiệm)": {"n": 2, "m": 2, "obj": "Min", "c": [2.0, 1.0], "A": [[1.0, 1.0], [-1.0, -1.0]], "b": [1.0, -3.0], "dau": ["<=", "<="], "cond": ["≥ 0", "≥ 0"]},
    "Mẫu 5: Miền nghiệm Không giới nội (Unbounded)": {"n": 2, "m": 2, "obj": "Min", "c": [-2.0, -3.0], "A": [[1.0, -1.0], [-2.0, 1.0]], "b": [2.0, 4.0], "dau": ["<=", "<="], "cond": ["≥ 0", "≥ 0"]}
}
